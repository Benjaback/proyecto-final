...
const ActionConfirmModal = ({ show, onConfirm, onCancel, data, actionType }) => {
    if (!show || !data) {
        return null;
    }
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-transparent">
            ...
            <div className="bg-gray-800 rounded-xl shadow-2xl p-6 w-11/12 max-w-sm border border-indigo-500/50 transform transition-all duration-300 scale-100 z-50">
                ...
                <div className="flex justify-end space-x-3">
                    ...
                    <button
                        onClick={onConfirm}
                        className={`py-2 px-4 font-bold rounded-lg transition duration-200 ${buttonClasses[actionType]}`}
                    >
                        {confirmText}
                    </button>
                </div>
